...
class WebProductsTest extends TestCase
{
    ...
    public function test_product_index()
    {
        ...
        $this->assertSame($this->getActionsFromRoute($route), [
            'controller' => 'WebProductsController', 'method' => 'index'
        ]);
    ...
    public function test_product_index_custom_request_method()
    {
        ...
        $this->assertSame($this->getActionsFromRoute($route), [
            'controller' => 'WebProductsController', 'method' => 'testPostMethod'
        ]);
    ...
    public function test_product_index_tabs()
    {
        ...
        $this->assertSame($this->getActionsFromRoute($route), [
            'controller' => 'WebProductsController', 'method' => 'testTabMethod'
        ]);
    }
    ...
    public function test_product_index_tabs_with_parameter()
    {
        ...
        $this->assertSame($this->getActionsFromRoute($route), [
            'controller' => 'WebProductsController',
    ...
    public function test_product_show()
    {
        ...
        $this->assertSame($this->getActionsFromRoute($route), [
            'controller' => 'WebProductsController', 'method' => 'show'
        ]);
    ...
    public function test_product_show_custom_request_method()
    {
        ...
        $this->assertSame($this->getActionsFromRoute($route), [
            'controller' => 'WebProductsController', 'method' => 'testPutMethod'
        ]);
    ...
    public function test_product_show_tabs()
    {
        ...
        $this->assertSame($this->getActionsFromRoute($route), [
            'controller' => 'WebProductsController', 'method' => 'testTabPutMethod'
        ]);
    }
