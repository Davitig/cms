...
class AdminTranslationController extends Controller implements HasMiddleware
{
    /**
    ...
    /**
     * Get the translation modal form by specified code.
     *
    ...
    {
        $input = $request->all('id', 'code', 'value', 'type');
