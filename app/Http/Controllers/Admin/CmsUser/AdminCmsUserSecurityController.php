...
class AdminCmsUserSecurityController extends Controller
{
    /**
    ...
    public function index(string $id)
    {
        ...
        return view('admin.cms_users.security.index', $data);
    }
    ...
    public function updatePassword(Request $request, string $id)
    {
        ...
        if ($request->expectsJson()) {
            return response()->json(fill_data('success', trans('general.updated')));
        }
