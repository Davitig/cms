...
<div class="form-group{{($error = $errors->first('type')) ? ' validate-has-error' : '' }}">
    ...
    <div class="col-sm-10">
        <div class="input-group">
            ...
            {{ html()->select('type', cms_config('listable.galleries.types'))
        ...
        <div class="form-group{{($error = $errors->first('admin_order_by')) ? ' validate-has-error' : '' }}">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    ...
                    {{ html()->select('admin_order_by', cms_config('listable.galleries.order_by'))
    ...
    <div class="col-sm-6">
        <div class="form-group{{($error = $errors->first('web_order_by')) ? ' validate-has-error' : '' }}">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-list-ol"></i></span>
                    {{ html()->select('web_order_by', cms_config('listable.galleries.order_by'))
        ...
        <div class="form-group{{($error = $errors->first('admin_sort')) ? ' validate-has-error' : '' }}">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    ...
                    {{ html()->select('admin_sort', cms_config('listable.galleries.sort'))
    ...
    <div class="col-sm-6">
        <div class="form-group{{($error = $errors->first('web_sort')) ? ' validate-has-error' : '' }}">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-sort"></i></span>
                    {{ html()->select('web_sort', cms_config('listable.galleries.sort'))
