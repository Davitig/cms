                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-xs-2">
                                        <div class="btn-action togglable pull-right">
                                            ...
                                            {{ html()->form('post', cms_route('galleries.visibility', [$item->id]))->id('visibility' . $item->id)->class('visibility')->open() }}
                                            ...
                                            {{ html()->form('delete', cms_route('galleries.destroy', [$parent->id, $item->id]))->class('form-delete')->open() }}
...
@push('body.bottom')
@include('admin._scripts.transfer', ['route' => cms_route('galleries.transfer', [$parent->id]), 'column' => 'collection_id', 'list' => $parentSimilar, 'parentId' => $parent->id])
