...
<li id="item{{$item->id}}" data-id="{{$item->id}}" data-pos="{{$item->position}}"
    data-url="{{cms_route('photos.edit', [$item->gallery_id, $item->id])}}" class="item col-md-3 col-sm-4 col-xs-6">
    <div class="album-image">
        ...
        <div class="image-options">
            ...
            <a href="#" data-delete="{{cms_route('photos.destroy', [$item->gallery_id, $item->id])}}" data-id="{{$item->id}}"><i class="fa fa-trash"></i></a>
        </div>
    </div>
</li>
@endif
