...
@section('content')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5 col-xs-2">
                                                <div class="btn-action toggleable pull-right">
                                                    ...
                                                    {{ html()->form('delete', cms_route('faq.destroy', [$parent->id, $item->id]))->class('form-delete')->open() }}
    ...
    @push('body.bottom')
        @include('admin._scripts.transfer', ['route' => cms_route('faq.transfer', [$parent->id]), 'column' => 'collection_id', 'list' => $parentSimilar, 'parentId' => $parent->id])
