                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-xs-2">
                                        <div class="btn-action togglable pull-right">
                                            ...
                                            {{ html()->form('post', cms_route('articles.visibility', [$item->id]))->id('visibility' . $item->id)->class('visibility')->open() }}
                                            ...
                                            {{ html()->form()->close() }}
                                            <a href="{{ cms_route('articles.files.index', [$item->id]) }}" class="btn btn-{{$item->has_file ? 'turquoise' : 'white'}}" title="{{trans('general.files')}}">
