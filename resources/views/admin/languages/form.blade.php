<div class="row g-4 mb-4">
    <div>
        <label for="full_name_inp" class="form-label">Full Name</label>
    ...
    <div>
        <label for="short_name_inp" class="form-label">Short Name</label>
    ...
    <div>
        <label for="language_inp" class="form-label">Short Name</label>
        ...
        <div class="form-text">
            ...
            <span class="text-primary">{{ request()->host() }}/<strong class="sample-lang">{{ $current->language ?: 'en' }}</strong>/about</span>
        </div>
    </div>
    <div>
