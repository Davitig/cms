...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements">
            <div class="fs-5">
                Menus
                <span class="badge badge-center rounded-pill bg-label-primary ms-2">{{ $menus->total() }}</span>
            </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{ cms_route('menus.edit', [$item->id]) }}">
    ...
    {{ $menus->links() }}
@endsection
@include('admin._scripts.checkbox_xhr', ['url' => cms_route('menus.updateMain')])
