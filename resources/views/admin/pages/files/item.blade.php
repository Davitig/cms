@if (! empty($item) || ! empty($itemInput))
    <li id="item{{$item->id}}" data-id="{{$item->id}}" data-pos="{{$item->position}}" data-url="{{cms_route('pages.files.edit', [$item->page_id, $item->id])}}" class="item col-md-2 col-sm-4 col-xs-6">
        <div class="album-image">
            ...
            <div class="image-options">
                ...
                <a href="#" data-url="{{cms_route('pages.files.visibility', [$item->id])}}" class="visibility">
