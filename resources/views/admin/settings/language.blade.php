...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            {{ html()->modelForm($current, 'post', cms_route('settings.language.save'))->data('ajax-form', $preferences->get('ajax_form'))
            ...
            <div class="row g-6 mb-6">
                ...
                <div class="col-xs">
                    <div @class(['form-check custom-option custom-option-basic',
                        'checked' => $current->get('exclude_main_language_from_url')
                    ])>
                        <label class="form-check-label custom-option-content" for="exclude_main_language_from_url_inp">
                            {{ html()->checkbox('exclude_main_language_from_url')->id('exclude_main_language_from_url_inp')
                            ->class('form-check-input') }}
                            <span class="custom-option-header">
                                <span class="h6 mb-0">Exclude Main Language From URL</span>
                            </span>
                            <span class="custom-option-body">
                                <small class="option-text">
                ...
                <div class="col-xs">
                    <div @class(['form-check custom-option custom-option-basic',
                        'checked' => $current->get('exclude_single_language_from_url')
                    ])>
                        <label class="form-check-label custom-option-content" for="exclude_single_language_from_url_inp">
                            {{ html()->checkbox('exclude_single_language_from_url')
                            ->id('exclude_single_language_from_url_inp')->class('form-check-input') }}
                            <span class="custom-option-header">
                                <span class="h6 mb-0">Exclude Single Language From URL</span>
                            </span>
                            <span class="custom-option-body">
                                <small class="option-text">
                                    Do not allow single available language to appear in URL.
                                </small>
                            </span>
                        </label>
                    </div>
                        ...
                        <label class="form-check-label custom-option-content" for="redirect_to_main_inp">
                            ...
                            <span class="custom-option-body">
                                <small class="option-text">
                                    ...
                                    This option will take action only if the
                                    <span class="text-decoration-underline">main language is excluded from URL.</span>
                                </small>
                            </span>
                        </label>
                    </div>
