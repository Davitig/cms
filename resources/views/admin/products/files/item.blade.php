    ...
    <li id="item{{$item->id}}" data-id="{{$item->id}}" data-pos="{{$item->position}}"
        ...
        <div class="album-image">
            ...
            <div class="image-options">
                ...
                <a href="#" data-url="{{cms_route('products.files.visibility', [$item->id])}}" class="visibility">
                    <i class="fa fa-eye{{$item->visible ? '' : '-slash'}}"></i>
                </a>
                <a href="#" data-modal="edit"><i class="fa fa-pencil"></i></a>
                <a href="#" data-delete="{{cms_route('products.files.destroy', [$item->product_id, $item->id])}}" data-id="{{$item->id}}"><i class="fa fa-trash"></i></a>
            </div>
        </div>
    </li>
@endif
