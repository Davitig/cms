    ...
    <ul class="nav nav-pills flex-column flex-md-row gap-md-0 gap-2 mb-6">
        <li class="nav-item">
            <a href="{{ cms_route('cms_users.show', [$current->id]) }}"
                @class(['nav-link', 'active' => $routeMatches(['cms_users.show'], false)])>
        ...
        <li class="nav-item">
            <a href="{{ cms_route('cms_users.edit', [$current->id]) }}"
                @class(['nav-link', 'active' => $routeMatches(['cms_users.edit'], false)])>
        ...
        <li class="nav-item">
            <a href="{{ cms_route('cms_users.security', [$current->id]) }}"
                @class(['nav-link', 'active' => $routeMatches(['cms_users.security'], false)])>
        ...
        <li class="nav-item">
            <a href="{{ cms_route('cms_users.preferences.index', [$current->id]) }}"
                @class(['nav-link', 'active' => $routeMatches(['cms_users.preferences.index'], false)])>
